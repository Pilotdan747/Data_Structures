...
public class ArrayRefSortedStringList implements ListInterface<String> {
     ...
     * (non-Javadoc)
     *
     * @see ch06.lists.ListInterface#add(java.lang.Object)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see ch06.lists.ListInterface#contains(java.lang.Object)
     */
    @Override
    public boolean contains(String aElement) {
	// TODO Auto-generated method stub
	return false;
    }
     ...
     * (non-Javadoc)
     *
     * @see ch06.lists.ListInterface#get(java.lang.Object)
     */
    @Override
    public String get(String aElement) {
	// TODO Auto-generated method stub
	return null;
    }
     ...
     * (non-Javadoc)
     *
     * @see ch06.lists.ListInterface#getNext()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see ch06.lists.ListInterface#reset()
     */
    @Override
    public void reset() {
	// TODO Auto-generated method stub
     ...
     * (non-Javadoc)
     *
     * @see ch06.lists.ListInterface#size()
     */
    @Override
    public int size() {
	// TODO Auto-generated method stub
